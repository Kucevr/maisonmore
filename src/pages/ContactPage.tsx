      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 h-full flex-grow">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-4xl md:text-7xl lg:text-[5.5rem] font-medium tracking-tight leading-[1.05] max-w-2xl">
            <RevealText>Based in Minsk, Belarus but available for your projects in{' '}</RevealText>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="flex flex-col">
              <RevealText delay={0.2}>
                ...
                <a href="tel:+375291234567" className="text-xl hover:opacity-50 transition-opacity">+375 29 123 45 67</a>
              </RevealText>
            </div>

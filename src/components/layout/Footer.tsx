  ...
  return (
    <footer ref={footerRef} className="bg-white text-black pt-24 px-6 md:px-12 lg:px-24 flex flex-col justify-between min-h-screen overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="w-full md:w-1/4 flex flex-col gap-4 text-sm mt-8 md:mt-0">
          <div className="flex gap-3">
            <span className="font-bold w-4 shrink-0">L</span>
            <span><RevealText>Praspyekt Nyezalyezhnastsi 116, Minsk, Belarus 220114</RevealText></span>
          </div>
          <div className="flex gap-3">
            <span className="font-bold w-4 shrink-0">P</span>
            <span><RevealText>+375 29 123 45 67</RevealText></span>
          </div>
          <div className="flex gap-3">
            <span className="font-bold w-4 shrink-0">C</span>
            <span><RevealText>contact@maisonmore.com</RevealText></span>
          </div>
        </div>
      </div>

      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mt-12 md:mt-24 pb-10 gap-8 md:gap-0">
